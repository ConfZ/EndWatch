...
static void find_obj2(u8* argv0) {
    ...
    if (afl_path) {
        ...
        tmp = alloc_printf("%s/hash-code.o", afl_path);
    ...
    if (slash) {
        ...
        *slash = '/';
        ...
        tmp = alloc_printf("%s/hash-code.o", dir);
    ...
    if (!access(AFL_PATH "/hash-code.o", R_OK)) {
        obj_path = AFL_PATH;
        return;
    }
...
static void edit_params(u32 argc, char** argv) {
  ...
  switch (bit_mode) {
    ...
    case 0:
      ...
      cc_params[cc_par_cnt++] = alloc_printf("%s/hash-code.o", obj_path);
//      cc_params[cc_par_cnt++] = alloc_printf("%s/nondet-funcs.o", obj_path);
      break;
    ...
    case 32:
      ...
      cc_params[cc_par_cnt++] = alloc_printf("%s/hash-code-32.o", obj_path);
      if (access(cc_params[cc_par_cnt - 1], R_OK))
          FATAL("-m32 is not supported by your compiler");
      break;
    ...
    case 64:
      ...
      cc_params[cc_par_cnt++] = alloc_printf("%s/hash-code-64.o", obj_path);
      if (access(cc_params[cc_par_cnt - 1], R_OK))
          FATAL("-m64 is not supported by your compiler");
      break;
